# -*- coding: utf-8 -*-
"""
Created on Tue Feb 15 15:16:29 2022
...
img_to_detect = cv2.imread('F:/study matrials/2022/Computer Vision- Python OCR & Object Detection Quick Starter/new_code/testing/scene2.jpg')
...
yolo_model = cv2.dnn.readNetFromDarknet('models/yolov2-tiny.cfg','models/yolov2-tiny.weights')
