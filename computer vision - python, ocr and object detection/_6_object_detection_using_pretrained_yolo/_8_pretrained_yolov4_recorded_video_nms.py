# -*- coding: utf-8 -*-
"""
Created on Tue Feb 15 15:52:57 2022
...
webcam_video_stream = cv2.VideoCapture("F:/study matrials/2022/Computer Vision- Python OCR & Object Detection Quick Starter/new_code/testing/video_sample.mp4")
...
while True:
    ...
    yolo_model = cv2.dnn.readNetFromDarknet('models/yolov4.cfg','models/yolov4.weights')
